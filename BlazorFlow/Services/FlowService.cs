...
namespace BlazorFlow.Data
{
    public class FlowService
    {
        ...
        Flow BuildFlow(int flowVersion)
        {
            ...
            var link2 = new FlowLink(2, node2, node3, cond1);
            var link3 = new FlowLink(3, node2, node4, cond2);
            var link4 = new FlowLink(4, node4, node5, cond3);
            var link5 = new FlowLink(5, node4, node6, cond4);
        ...
        FlowAnswer[] BuildFlowAnswers()
        {
            ...
            {
                new FlowAnswer(1, "YES", "1", "Yes", "Oui"),
                new FlowAnswer(2, "NO", "0", "No", "Non")
            };
        }
    }
}
