...
namespace BlazorFlow.Migrations
{
    ...
    [Migration("20200531224845_added value type to user answers")]
    partial class addedvaluetypetouseranswers
    {
            ...
            modelBuilder.Entity("BlazorFlow.Data.Contact", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ContactId = 1,
                            DateOfBirth = new DateTime(2020, 5, 31, 18, 48, 44, 776, DateTimeKind.Local).AddTicks(6190),
                            FirstName = "John",
                            LastName = "Doe"
                        },
                        new
                        {
                            ContactId = 2,
                            DateOfBirth = new DateTime(2020, 5, 31, 18, 48, 44, 784, DateTimeKind.Local).AddTicks(8740),
                            FirstName = "Eddie",
                            LastName = "Murphy"
                        },
                        new
                        {
                            ContactId = 3,
                            DateOfBirth = new DateTime(2020, 5, 31, 18, 48, 44, 784, DateTimeKind.Local).AddTicks(8790),
                            FirstName = "Jim",
                            LastName = "Carrey"
                        });
                });
            ...
            modelBuilder.Entity("BlazorFlow.Data.UserFlowAnswer", b =>
                {
                    ...
                    b.Property<string>("UserFlowAnswerType")
                        .IsRequired()
                        .HasColumnType("text");
