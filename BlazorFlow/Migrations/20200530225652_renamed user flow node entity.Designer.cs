...
namespace BlazorFlow.Migrations
{
    ...
    [Migration("20200530225652_renamed user flow node entity")]
    partial class renameduserflownodeentity
    {
            ...
            modelBuilder.Entity("BlazorFlow.Data.Contact", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ContactId = 1,
                            DateOfBirth = new DateTime(2020, 5, 30, 18, 56, 51, 363, DateTimeKind.Local).AddTicks(6630),
                            FirstName = "John",
                            LastName = "Doe"
                        },
                        new
                        {
                            ContactId = 2,
                            DateOfBirth = new DateTime(2020, 5, 30, 18, 56, 51, 372, DateTimeKind.Local).AddTicks(840),
                            FirstName = "Eddie",
                            LastName = "Murphy"
                        },
                        new
                        {
                            ContactId = 3,
                            DateOfBirth = new DateTime(2020, 5, 30, 18, 56, 51, 372, DateTimeKind.Local).AddTicks(890),
                            FirstName = "Jim",
                            LastName = "Carrey"
                        });
                });
