...
namespace BlazorFlow.Migrations
{
    ...
    [Migration("20200526004758_refactored userflow nodes and answers")]
    partial class refactoreduserflownodesandanswers
    {
            ...
            modelBuilder.Entity("BlazorFlow.Data.Contact", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ContactId = 1,
                            DateOfBirth = new DateTime(2020, 5, 25, 20, 47, 57, 948, DateTimeKind.Local).AddTicks(1310),
                            FirstName = "John",
                            LastName = "Doe"
                        },
                        new
                        {
                            ContactId = 2,
                            DateOfBirth = new DateTime(2020, 5, 25, 20, 47, 57, 956, DateTimeKind.Local).AddTicks(7330),
                            FirstName = "Eddie",
                            LastName = "Murphy"
                        },
                        new
                        {
                            ContactId = 3,
                            DateOfBirth = new DateTime(2020, 5, 25, 20, 47, 57, 956, DateTimeKind.Local).AddTicks(7380),
                            FirstName = "Jim",
                            LastName = "Carrey"
                        });
                });
