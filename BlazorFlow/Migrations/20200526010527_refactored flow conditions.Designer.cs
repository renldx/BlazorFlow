...
namespace BlazorFlow.Migrations
{
    ...
    [Migration("20200526010527_refactored flow conditions")]
    partial class refactoredflowconditions
    {
            ...
            modelBuilder.Entity("BlazorFlow.Data.Contact", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ContactId = 1,
                            DateOfBirth = new DateTime(2020, 5, 25, 21, 5, 26, 713, DateTimeKind.Local).AddTicks(3480),
                            FirstName = "John",
                            LastName = "Doe"
                        },
                        new
                        {
                            ContactId = 2,
                            DateOfBirth = new DateTime(2020, 5, 25, 21, 5, 26, 721, DateTimeKind.Local).AddTicks(5420),
                            FirstName = "Eddie",
                            LastName = "Murphy"
                        },
                        new
                        {
                            ContactId = 3,
                            DateOfBirth = new DateTime(2020, 5, 25, 21, 5, 26, 721, DateTimeKind.Local).AddTicks(5480),
                            FirstName = "Jim",
                            LastName = "Carrey"
                        });
                });
