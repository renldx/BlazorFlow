...
namespace BlazorFlow.Migrations
{
    ...
    [Migration("20200526011455_refactored flow condition operators")]
    partial class refactoredflowconditionoperators
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorFlow.Data.Contact", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ContactId = 1,
                            DateOfBirth = new DateTime(2020, 5, 25, 21, 14, 54, 806, DateTimeKind.Local).AddTicks(3720),
                            FirstName = "John",
                            LastName = "Doe"
                        },
                        new
                        {
                            ContactId = 2,
                            DateOfBirth = new DateTime(2020, 5, 25, 21, 14, 54, 814, DateTimeKind.Local).AddTicks(5390),
                            FirstName = "Eddie",
                            LastName = "Murphy"
                        },
                        new
                        {
                            ContactId = 3,
                            DateOfBirth = new DateTime(2020, 5, 25, 21, 14, 54, 814, DateTimeKind.Local).AddTicks(5430),
                            FirstName = "Jim",
                            LastName = "Carrey"
                        });
                });
            ...
            modelBuilder.Entity("BlazorFlow.Data.FlowCondition", b =>
                {
                    ...
                    b.HasIndex("FlowLinkConditionId");
            ...
            modelBuilder.Entity("BlazorFlow.Data.FlowCondition", b =>
                {
                    b.HasOne("BlazorFlow.Data.FlowLinkCondition", "FlowLinkCondition")
                        .WithMany("FlowConditions")
                        .HasForeignKey("FlowLinkConditionId")
