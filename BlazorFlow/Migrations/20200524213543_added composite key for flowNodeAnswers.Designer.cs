...
namespace BlazorFlow.Migrations
{
    ...
    [Migration("20200524213543_added composite key for flowNodeAnswers")]
    partial class addedcompositekeyforflowNodeAnswers
    {
            ...
            modelBuilder.Entity("BlazorFlow.Data.Contact", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ContactId = 1,
                            DateOfBirth = new DateTime(2020, 5, 24, 17, 35, 42, 758, DateTimeKind.Local).AddTicks(5980),
                            FirstName = "John",
                            LastName = "Doe"
                        },
                        new
                        {
                            ContactId = 2,
                            DateOfBirth = new DateTime(2020, 5, 24, 17, 35, 42, 766, DateTimeKind.Local).AddTicks(9390),
                            FirstName = "Eddie",
                            LastName = "Murphy"
                        },
                        new
                        {
                            ContactId = 3,
                            DateOfBirth = new DateTime(2020, 5, 24, 17, 35, 42, 766, DateTimeKind.Local).AddTicks(9440),
                            FirstName = "Jim",
                            LastName = "Carrey"
                        });
                });
