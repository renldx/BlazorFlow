...
namespace BlazorFlow.Migrations
{
    ...
    [Migration("20200529224922_refactored conditions")]
    partial class refactoredconditions
    {
            ...
            modelBuilder.Entity("BlazorFlow.Data.Contact", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ContactId = 1,
                            DateOfBirth = new DateTime(2020, 5, 29, 18, 49, 21, 927, DateTimeKind.Local).AddTicks(4560),
                            FirstName = "John",
                            LastName = "Doe"
                        },
                        new
                        {
                            ContactId = 2,
                            DateOfBirth = new DateTime(2020, 5, 29, 18, 49, 21, 938, DateTimeKind.Local).AddTicks(8000),
                            FirstName = "Eddie",
                            LastName = "Murphy"
                        },
                        new
                        {
                            ContactId = 3,
                            DateOfBirth = new DateTime(2020, 5, 29, 18, 49, 21, 938, DateTimeKind.Local).AddTicks(8050),
                            FirstName = "Jim",
                            LastName = "Carrey"
                        });
                });
